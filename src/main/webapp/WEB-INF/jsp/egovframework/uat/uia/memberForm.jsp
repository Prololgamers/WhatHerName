...
<div class="container mt-5 pt-5">
   <div class="row">
     ...
     <form:form  method="post" action="${contextPath}/uat/uia/login.do">
         ...
         <div class="form-group">
             <label for="username-email">권한</label>
             <input name="user_id" value='' id="username-email" placeholder="ID" type="text" class="form-control" />
         </div>
         <div class="form-group">
             <label for="username-email">사용여부</label>
             <input name="user_id" value='' id="username-email" placeholder="ID" type="text" class="form-control" />
         </div>
         <div class="form-group">
             <input type="submit" class="btn btn-default btn-login-submit btn-block m-t-md" value="등록" />
         </div>
                 
         <div class="form-group" style="margin-bottom: auto;">
             <a href="${contextPath}/uat/uia/usrList.do" class="btn btn-default btn-block m-t-md " style="margin-top: 10px;"> 뒤로가기</a>
         </div>
     </form:form>
       </div>
     </div>
